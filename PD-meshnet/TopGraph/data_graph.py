...
class Subset(torch.utils.data.Dataset):
    def __init__(self, dataset, indices):
        ...
        self.max_node_deg = dataset.max_node_deg
...
def enhance_TUDataset(ds):
    ...
    for d in ds:
        ...
        boundary_edges = get_boundary_info(d)
        ...
        for k, v in Counter(d.boundary_edges.flatten().tolist()).items():
            degree[k] = v
...
def dataset_factory(dataset_name, verbose=True):
    ...
    elif dataset_name in PLANETOID_DATASET_NAMES:
