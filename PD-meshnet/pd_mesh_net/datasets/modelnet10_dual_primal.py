...
class ModelNet10(BaseDualPrimalDataset):
    r"""The ModelNet10 dataset from the `"3D ShapeNets: A Deep Representation for Volumetric Shapes"
    ...
    Attributes:
        None.
    """
    urls = ['https://www.dropbox.com/s/y662o3m1zm3rlqk/ModelNet10.zip']

    valid_categories = sorted(
        ['bed', 'monitor', 'desk', 'chair', 'dresser', 'toilet', 'sofa', 'table', 'night_stand', 'bathtub'])
    ...
    def __init__(self,
        ...
        self.__subdivision_type = 'ModelNet10'
            ...
            while (have_samples_to_insert):
                ...
                for category in self.__categories:
                    if (sample_idx_in_category <
                        ...
                        if (self.__split == 'train'):
                            (self.processed_file_names_train) += filenames_per_category[category][
                                                               3 * sample_idx_in_category:3 * sample_idx_in_category + 3]
                        else:
                            (self.processed_file_names_test) += filenames_per_category[
